...
class NewProxyPageLocatoros():
    ...
    NEW_PROXY_FIELD_MIDDLE_NAME_INPUT = (By.CSS_SELECTOR, 'ui-input[label="Отчество"] > mat-form-field > div > div> div > input')
    ...
    NEW_PROXY_LAST_NAME_FIELD_VALIDATION_MANY_LATTERS = (By.CSS_SELECTOR, 'ui-input.ng-dirty.ng-touched.ng-invalid')
    NEW_PROXY_NAME_FIELD_VALIDATION_MANY_LATTERS = (By.CSS_SELECTOR, 'ui-input.ng-dirty[label="Имя"].ng-invalid.ng-touched')
    NEW_PROXY_MIDDLE_NAME_FIELD_VALIDATION_MANY_LATTERS = (By.CSS_SELECTOR, 'ui-input.ng-dirty[label="Отчество"].ng-invalid.ng-touched')